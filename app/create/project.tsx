...
import { HelpCircle, Layers, Plus, Rocket, Target, UploadCloud } from "lucide-react";
        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-white">
              Create New <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-emerald-400">Project</span>
            </h1>
            <p className="text-lg text-slate-400 max-w-xl">
              Turn your unfinished Projects into a collaborative opportunitya. Fill in the details to find the perfect partner.
            </p>
          </div>
        ...
        <form className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7 space-y-8">
            ...
            <section className="group relative bg-neutral-900/50 border border-neutral-800 rounded-3xl p-2 transition-all hover:border-indigo-500/50">
              <label className="relative flex flex-col items-center justify-center w-full h-[400px] bg-neutral-950/50 rounded-[1.4rem] border-2 border-dashed border-neutral-800 group-hover:bg-indigo-500/5 transition-all cursor-pointer overflow-hidden">
                <div className="z-10 flex flex-col items-center gap-4">
                  <div className="p-4 rounded-2xl bg-neutral-900 border border-neutral-800 group-hover:scale-110 group-hover:text-indigo-400 transition-all">
                    <UploadCloud className="w-8 h-8" />
                  </div>
                  <div className="text-center">
                    <p className="text-lg font-bold text-white">Drop your project preview</p>
                    <p className="text-sm text-neutral-500">PNG, JPG or WebP (Max 5MB)</p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 gap-6 bg-neutral-900/30 p-8 rounded-3xl border border-neutral-800">
              <div className="space-y-2">
                <label className="text-sm font-bold uppercase tracking-wider text-neutral-500 ml-1">Project Title</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold uppercase tracking-wider text-neutral-500 ml-1">Description</label>
                <textarea 
                  rows={6} 
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="space-y-3">
                    ...
                    <input type="range" className={`w-full h-1.5 bg-neutral-800 rounded-lg appearance-none cursor-pointer ${item.color}`} />
                  </div>
                ))}
              </div>
            </section>
          ...
          <div className="md:hidden pt-8">
            <button className="w-full py-5 bg-linear-to-r from-indigo-600 to-purple-600 text-white font-black rounded-2xl shadow-xl shadow-indigo-500/20">
              PUBLISH PROJECT
            </button>
          </div>
        </form>
