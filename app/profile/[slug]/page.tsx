...
<div className="w-full h-screen min-h-screen bg-neutral-950 text-white flex flex-col sm:flex-row overflow-y-auto">
  ...
  <div className="sm:w-[360px] w-full sm:h-full flex justify-center items-center p-6">
    ...
    <div className="w-full bg-neutral-900 border border-neutral-800 rounded-2xl p-6 flex flex-col gap-5">
      ...
      <p className="text-sm text-neutral-300 text-center leading-relaxed">
        I enjoy building small SaaS products and collaborating with developers
        who like shipping ideas quickly.
      </p>
  ...
  {/* RIGHT SIDE */}
  <div className="flex-1 flex flex-col gap-6 p-6 sm:justify-center">
    ...
    <div className="flex gap-3 overflow-x-auto border-b border-neutral-800 pb-2 text-sm">
      ...
      <button onClick={()=>setInView("Posted")} className={`${InView=="Posted"?"text-blue-500":"text-neutral-200"} hover:cursor-pointer hover:text-white`}>
        Projects Posted
      </button>

      <button onClick={()=>setInView("Collaborated")} className={`${InView=="Collaborated"?"text-blue-500":"text-neutral-200"} hover:cursor-pointer hover:text-white`}>
        Projects Collaborated
      </button>

      <button onClick={()=>setInView("Completed")} className={`${InView=="Completed"?"text-blue-500":"text-neutral-200"} hover:cursor-pointer hover:text-white`}>
        Completed
      </button>
