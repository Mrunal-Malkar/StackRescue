...
export const Navbar = () => {
  ...
  return (
    <div className="h-78 md:h-64 flex justify-center items-center ">
      <nav
        className={`fixed top-8 lg:w-[60%] w-[95%] rounded-xl bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "shadow-md  backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6"}`}
      >
        {/* Logo */}
